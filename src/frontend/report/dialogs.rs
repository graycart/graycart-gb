...
use crate::frontend::settings::FrontendSettings;
use crate::frontend::{audio::AudioDevicePref, brand};
use egui::Context;
...
mod tests {
    use super::*;
    use crate::frontend::report::github::RecordingFiler;
    ...
    fn dismiss_does_not_call_api() {
        ...
        assert!(crate::frontend::report::envelope::load_pending(dir.path()).is_none());
    }
}
