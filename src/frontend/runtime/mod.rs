...
pub use frame::{FramePacket, LatestDebug, LatestFrame};
...
pub struct RuntimeConfig {
    ...
    pub audio_gain: f32,
    pub audio_output: crate::frontend::audio::AudioDevicePref,
...
impl EmulationRuntime {
    ...
    pub fn take_debug_snapshot(&self) -> Option<graycart::MachineDebug> {
